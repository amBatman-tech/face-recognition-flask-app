...
class Face:
    def __init__(self, app):
        ...
        self.db = app.db
        self.faces = [] #storage for all face in chaches array of face object
        self.known_encoding_faces = [] #face data for recognize
        self.face_user_keys = {}
        self.load_all()

    def load_user_by_user_key(self, index_key = 0):
    ...
    def recognize(self, unknown_filename):
        ...
        for matched in results:
            ...
            if matched:
                ...
                user_id = self.load_user_by_user_key(index_key)
                return user_id
